<?php
    ...
    foreach ($articles as $articleKey => $article) 
     ...
     $articlesByCategoryID = $articleController->getByCategoryId($categoryId);
    // $articles = $articlesByCategoryID[0];
    //   echo "<pre>";
    // print_r($articles);
    require_once($rootPath . '/controller/userController.php');
    $userController = new UserController();
    // echo "<pre>";
    //  print_r ($articlesByCategoryID);
?>
            ...
            <div class="col-md-8 animate-box fadeInLeft animated-fast" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box fadeInUp animated-fast">
                        <a href="single.html" class="fh5co_magna py-2"> <?php echo $article['title'] ?>
                        </a> <a href="#" class="fh5co_mini_time py-3"> <?php  $user = $userController->getUserName($article['user_id']);
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box fadeInUp animated-fast">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1494px;"><div class="owl-item active" style="width: 363.333px; margin-right: 10px;"><div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="../../frontendAssets/images/39-324x235.jpg" alt=""></div>
                    <div>
                ...
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="../../frontendAssets/images/joe-gardner-75333.jpg" alt=""></div>
                    <div>
                        <a href="#" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                    </div>
                ...
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="../../frontendAssets/images/seth-doyle-133175.jpg" alt=""></div>
                    <div>
                        <a href="#" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                    </div>
